                ...
                <tr style="border-collapse:collapse">
                    <td valign="top" style="padding:0;Margin:0">
                        <table class="es-header" cellspacing="0" cellpadding="0" align="center"
                            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%;background-color:#2d3748;background-repeat:repeat;background-position:center top">
                            <tbody>
                                <tr style="border-collapse:collapse">
                        ...
                        <table class="es-content" cellspacing="0" cellpadding="0" align="center"
                            ...
                            <tbody>
                                <tr style="border-collapse:collapse">
                                    <td style="padding:0;Margin:0;background-color:#2d3748" bgcolor="#2d3748"
                                        align="center">
                                                                                ...
                                                                                <tr style="border-collapse:collapse">
                                                                                    <td class="es-m-txt-l"
                                                                                        ...
                                                                                        <p
                                                                                            ...
                                                                                            @lang('The following vehicles have upcoming expirations (less than 15 days to go):')
                                                                                            <br>
                                                                                            <br>
                                                                                            @foreach ($expirations as $expiration)
                                                                                            <h4>
                                                                                                @lang('Plate'): {{ $expiration->truck->plate }} <br>
                                                                                                @lang('Name'): {{ $expiration->name }} <br>
                                                                                                @lang('Deadline'): {{ $expiration->deadline->format('d-m-Y') }}
                                                                                            </h4>
                                                                                            <hr>
                                                                                            @endforeach
                                                                                        </p>
                                                                                ...
                                                                                <tr style="border-collapse:collapse">
                                                                                    <td align="left"
                                                                                        ...
                                                                                        <p
                                                                                            ...
                                                                                            © {{ Carbon\Carbon::now()->format('Y') }} {{ config('app.name') }}. @lang('All right reserved').
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
